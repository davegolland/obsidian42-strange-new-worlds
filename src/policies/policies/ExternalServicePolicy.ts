import { WikilinkEquivalencePolicy } from "../base/WikilinkEquivalencePolicy";
...
export class ExternalServicePolicy implements WikilinkEquivalencePolicy {
  ...
  countReferences(references: Link[] | undefined): number { return references ? references.length : 0; }
  filterReferences(references: Link[] | undefined): Link[] { return references || []; }
}
